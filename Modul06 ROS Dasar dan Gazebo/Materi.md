...
3. ROS 2 Tutorials (Official): https://docs.ros.org/en/humble/Tutorials.html
4. Pyo, Y. et al. (2017). *ROS Robot Programming*. ROBOTIS.
5. URDF Tutorial: https://docs.ros.org/en/humble/Tutorials/Intermediate/URDF/URDF-Main.html
6. Joseph, L. (2018). *ROS Robotics Projects* (2nd ed). Packt.

---

Dokumen ini menjadi acuan utama materi Modul 08 ROS 2 Dasar dan Gazebo.
