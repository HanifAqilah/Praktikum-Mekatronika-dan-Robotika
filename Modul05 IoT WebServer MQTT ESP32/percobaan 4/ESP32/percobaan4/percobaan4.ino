...
// NOTE: Endpoint /api/sensors/data does NOT require JWT auth.
// Authentication (JWT) is only required for frontend API calls
// to view data. ESP32 submits data freely.
...
void setup() {
  ...
  delay(500);
  Serial.println("\n=== Percobaan 4 – JWT WebSocket Sensor Publisher ===");
